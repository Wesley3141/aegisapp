...
const ToDoList = () => {
  ...
  return (
    <div className="h-screen w-screen bg-gray-800 text-gray-100 overflow-hidden flex flex-col">
      <header className="acrylic-header flex justify-between items-center p-4">
        <button
          onClick={() => navigate('/')}
          className="bg-gray-600 text-gray-100 px-4 py-2 rounded hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 mt-8" // Adjusted margin-top
        >
          Go Back
        </button>
        <h1 className="text-3xl font-semibold mt-8">To-Do List</h1> {/* Adjusted margin-top */}
      </header>
      <main className="acrylic-main flex flex-col flex-grow p-4">
